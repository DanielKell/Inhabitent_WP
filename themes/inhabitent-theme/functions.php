 ...
 */
function inhabitent_scripts() { //Can change this name for my specific site. Will need for adding libraries, etc
    ...
    wp_enqueue_script( 'inhabitent-search-bar-toggle', get_template_directory_uri() . '/build/js/search-bar.min.js', array('jquery'), false, true );
